 ...
 *       allow to sendData IP datagrams through layer-2 interfaces (e.g. Ethernet)</li>
	...
	implements IPInterfaceListener
{
    ...
    /**
     * Send an IP message.
     * This method can be used by upper layers (applications) to sendData IP datagrams.
     * 
    ...
    public void send(IPAddress src, IPAddress dst, int protocol, Message payload)
		throws Exception {
    	//System.out.println("IPLayer::sendData(" + src + "," + dst + "," + protocol + "," + payload + ")");
